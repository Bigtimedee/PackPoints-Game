...
**Last verified against codebase:** 2026-09-14 (social PNG tofu: outline Inter in gameImageRenderer)
...
**Vitest integration tests** (`server/tests/` — 15 test files, 227+ tests, most require a live PostgreSQL connection):
...
| `gameImageRender.test.ts` | 4 | Social PNG tofu guard: no `<text>` / sans-serif, outlined Inter, painted gold/white/accent regions (no DB) |
