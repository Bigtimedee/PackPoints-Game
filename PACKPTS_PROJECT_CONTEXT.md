...
- [x] `/sets` Goldin-quiet polish (2026-09-08): index + detail match `docs/SETS_POLISH.md` (Maker sets, Surface A cover else masked stack, honest `{n} cards`, short-shelf banner below the ≥10 gate, no Times Played / Maker Rate / currency chrome). Play uses the set’s real card count (5–20), not a hardcoded 10.
